...
public class GrantBotMain extends Activity implements IOIOLooperProvider {
	...
	TextView mountXValue, mountYValue, motorPWValue, wheelPWValue,
			...
			diagRIRValue, diagLIRValue, halleffectValue;
	TextView stateText;
	TextView state;
	...
	// 8:Side Right IR
	// 9:Back IR
	public void setTextFields(double[] values, Boolean halleffect, final String currentState) {
	...
	public void setLayout() {
		...
		halleffectValue = new TextView(this);
